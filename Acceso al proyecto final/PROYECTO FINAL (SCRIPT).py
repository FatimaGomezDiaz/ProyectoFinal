...
def connect_to_database(df):
    ...
    # Insertar datos en la tabla Estados solo si no existen
    insertar_estado = "INSERT IGNORE INTO Estados (Estado) VALUES (%s)"
...
def create_dash_app(df):
    ...
    def update_charts_and_info(selected_year, selected_estado):
        ...
        zonas = {
            ...
            "Noreste": ["Coahuila de Zaragoza", "Nuevo León", "Tamaulipas", "Chihuahua", "Durango", "Zacatecas",
                        "San Luis Potosí"],
            "Occidente": ["Aguascalientes", "Colima", "Guanajuato", "Jalisco", "Michoacán de Ocampo", "Nayarit",
                          "Querétaro"],
            "Centro": ["Ciudad de México", "Hidalgo", "Morelos", "Puebla", "Tlaxcala"],
